...
const STRINGS = Object.freeze({
  hy: Object.freeze({
    ...
    // PO + delivery-note template (Phase 1 ERP — Wave 17)
    'po.title': 'Գնման պատվեր',
    'po.number': 'Համար',
    'po.date': 'Ամսաթիվ',
    'po.expectedDate': 'Ակնկալվող առաքման ամսաթիվ',
    'po.vendor': 'Մատակարար',
    'po.vendorCode': 'Մատակարարի կոդ',
    'po.hvhh': 'ՀՎՀՀ',
    'po.address': 'Հասցե',
    'po.phone': 'Հեռախոս',
    'po.contact': 'Կոնտակտային անձ',
    'po.status': 'Կարգավիճակ',
    'po.status.rfq': 'Հայտ',
    'po.status.confirmed': 'Հաստատված',
    'po.status.partial': 'Մասնակի ստացված',
    'po.status.received': 'Ստացված',
    'po.status.billed': 'Հաշվառված',
    'po.status.cancelled': 'Չեղարկված',
    'po.items': 'Ապրանքների ցանկ',
    'po.line.no': '№',
    'po.line.name': 'Անվանում',
    'po.line.uom': 'Չ.Մ.',
    'po.line.quantity': 'Քանակ',
    'po.line.unitCost': 'Գին',
    'po.line.amount': 'Գումար',
    'po.subtotal': 'Ընդհանուր առանց ԱԱՀ',
    'po.vat': 'ԱԱՀ 20%',
    'po.total': 'Ընդհանուր',
    'po.notes': 'Նշումներ',
    'po.signature': 'Հաստատում եմ: Ամսաթիվ, ստորագրություն',
    // Delivery note
    'deliveryNote.title': 'Առաքման նշագիր',
    'deliveryNote.number': 'Համար',
    'deliveryNote.receivedAt': 'Ընդունման ամսաթիվ',
    'deliveryNote.basedOnPO': 'Հիմնված պատվերի վրա',
    'deliveryNote.vendor': 'Մատակարար',
    'deliveryNote.warehouse': 'Պահեստ',
    'deliveryNote.location': 'Վայր',
    'deliveryNote.items': 'Ընդունված ապրանքներ',
    'deliveryNote.receivedBy': 'Ընդունել է',
    'deliveryNote.signature': 'Ամսաթիվ, ստորագրություն',
  }),
  en: Object.freeze({
    ...
    'po.status.billed': 'Billed',
    'po.status.cancelled': 'Cancelled',
    'po.items': 'Line items',
    'po.line.no': '#',
    'po.line.name': 'Description',
    'po.line.uom': 'UoM',
    'po.line.quantity': 'Qty',
    'po.line.unitCost': 'Unit cost',
    'po.line.amount': 'Amount',
    'po.subtotal': 'Subtotal (excl. VAT)',
    'po.vat': 'VAT 20%',
    'po.total': 'Total',
    'po.notes': 'Notes',
    'po.signature': 'Approved by: date, signature',
    // Delivery note
    'deliveryNote.title': 'Delivery Note',
    'deliveryNote.number': 'Number',
    'deliveryNote.receivedAt': 'Received at',
    'deliveryNote.basedOnPO': 'Based on PO',
    'deliveryNote.vendor': 'Vendor',
    'deliveryNote.warehouse': 'Warehouse',
    'deliveryNote.location': 'Location',
    'deliveryNote.items': 'Received items',
    'deliveryNote.receivedBy': 'Received by',
    'deliveryNote.signature': 'Date, signature',
  }),
  ru: Object.freeze({
    ...
    // PO + delivery-note template (Phase 1 ERP — Wave 17)
    'po.title': 'Заказ на закупку',
    'po.number': 'Номер',
    'po.date': 'Дата',
    'po.expectedDate': 'Ожидаемая дата поставки',
    'po.vendor': 'Поставщик',
    'po.vendorCode': 'Код поставщика',
    'po.hvhh': 'ИНН',
    'po.address': 'Адрес',
    'po.phone': 'Телефон',
    'po.contact': 'Контактное лицо',
    'po.status': 'Статус',
    'po.status.rfq': 'Запрос',
    'po.status.confirmed': 'Подтверждён',
    'po.status.partial': 'Частично получен',
    'po.status.received': 'Получен',
    'po.status.billed': 'Выставлен счёт',
    'po.status.cancelled': 'Отменён',
    'po.items': 'Список товаров',
    'po.line.no': '№',
    'po.line.name': 'Наименование',
    'po.line.uom': 'Ед.',
    'po.line.quantity': 'Кол-во',
    'po.line.unitCost': 'Цена',
    'po.line.amount': 'Сумма',
    'po.subtotal': 'Итого без НДС',
    'po.vat': 'НДС 20%',
    'po.total': 'Итого',
    'po.notes': 'Примечания',
    'po.signature': 'Утверждаю: дата, подпись',
    // Delivery note
    'deliveryNote.title': 'Накладная на поставку',
    'deliveryNote.number': 'Номер',
    'deliveryNote.receivedAt': 'Дата приёмки',
    'deliveryNote.basedOnPO': 'На основании заказа',
    'deliveryNote.vendor': 'Поставщик',
    'deliveryNote.warehouse': 'Склад',
    'deliveryNote.location': 'Место',
    'deliveryNote.items': 'Принятые товары',
    'deliveryNote.receivedBy': 'Принял',
    'deliveryNote.signature': 'Дата, подпись',
  }),
});
